...
const Index = () => (
  <Layout>
    ...
    <HomeHero />
    <HomePageSection title="WEDDINGS" description="Say yes to the perfect wedding venue.
    ...
    <HomePageSection flex title="PARTIES" description="Throw the best party in town.
    ...
    <HomePageSection title="EVENTS" description="Make your event stand out from the crowd.
    ...
    <HomePageSection flex title="Hospitality" description="Deliver an event with a difference.
